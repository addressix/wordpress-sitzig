...
<?php if ($_GET['m']) {
    ...
    case 2:
      ...
      break;
    case 3:
      $msg = 'Fehler: Keine Gruppe gesetzt';
      break;
    case 401:
    case 403:
...
<form id="event" name="event" method="post" class="event" action="admin-post.php">
    ...
    <input type="hidden" name="action" value="sitzig_new">
<div id="post-body" class="columns-2">
<div id="post-body-content">
    <label id="title-prompt-text" for="eventtitle">Titel</label>
    <input id="eventtitle" type="text" name="eventtitle" size="30" value="">
...
?>
 ...
 <label id="place-prompt-text" for="place">Wo</label>
	<input id="place" type="text" name="place" size="30" value="">

 <label id="street-prompt-text" for="address">Strasse/Nr</label>
	<input id="street" type="text" name="address" size="30" value="">

 <label id="city-prompt-text" for="city">Ort</label>
	<input id="city" type="text" name="city" size="30" value="">
<?php /*
